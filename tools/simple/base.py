            ...
            if model_response.content:
                ...
                if metadata.get("is_blocked_by_safety"):
                    ...
                    if finish_reason == "STOP":
                        ...
                        try:
                            # Sync SDK call wrapped (see FORK.md) — same reason
                            # as the primary call above.
    ...
    def _parse_response(self, raw_text: str, request, model_info: Optional[dict] = None):
        ...
        if continuation_data:
            ...
            if model_info:
                ...
                model_name = getattr(model_response, "model_name", None) or model_info.get("model_name")
                if model_name:
                    metadata["model_used"] = model_name
                response_metadata = getattr(model_response, "metadata", None)
                if isinstance(response_metadata, dict):
                    provider_model_name = response_metadata.get("provider_model_name")
