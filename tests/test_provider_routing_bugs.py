...
class TestProviderMetadataBug:
    ...
    def test_provider_used_metadata_included(self):
        ...
        model_response = Mock(
            ...
            metadata={"provider_model_name": "upstream-model"},
        )
        model_info = {
        ...
        assert result.metadata["model_used"] == "logical-model", "model_used should be the canonical logical model"
        assert result.metadata["provider_model_name"] == "upstream-model"
