...
- Sync version to config.py [skip ci]
  ([`e25fc52`](https://github.com/bigl34/pal-mcp-server/commit/e25fc527be68e805a0dcc23261fe1e70cdda7ab9))

### Documentation

- Document logical model profiles
  ([`0c92102`](https://github.com/bigl34/pal-mcp-server/commit/0c921022fed4962358dc9b692755e5d7714128ba))

### Features

- Support logical OpenAI model profiles
  ([`761b550`](https://github.com/bigl34/pal-mcp-server/commit/761b5502c8d14799036eab6b7779cb1680e18667))
...
- Sync version to config.py [skip ci]
  ([`3e7168a`](https://github.com/bigl34/pal-mcp-server/commit/3e7168ad4aa301536276d33e9f5d0d31f52d31f6))

### Features

- Add clink model selection and claude subscription-auth hardening
  ([`fa910ea`](https://github.com/bigl34/pal-mcp-server/commit/fa910ea9f68c99dbc5c4850b95ae897fd5498d4e))
...
- Add fable latest router alias
  ([`2d693f2`](https://github.com/bigl34/pal-mcp-server/commit/2d693f2ead0db742c17c6550ef728edd3c38eb23))

- **ci**: Resolve OpenRouter fable alias conflict [Autofix GH Workflow]
  ([`6cf385f`](https://github.com/bigl34/pal-mcp-server/commit/6cf385f091c3b3f2bae3c10bbb5dccfd75ac7a96))

### Chores

- Ignore generated checkpoint false positives
  ([`d022b09`](https://github.com/bigl34/pal-mcp-server/commit/d022b092e05fb6b1c58138f6f7b5d9e60b1e4ff5))

- Sync version to config.py [skip ci]
  ([`1c3a84d`](https://github.com/bigl34/pal-mcp-server/commit/1c3a84d3c31ba204fd37dfb86dec1b267d0f3901))

### Continuous Integration

- Stabilize lint formatter version [Autofix GH Workflow]
  ([`0458727`](https://github.com/bigl34/pal-mcp-server/commit/04587272bbab880a52d9a560eaea469ba48be574))

### Testing

- Reset model restrictions between tests
  ([`1f209d5`](https://github.com/bigl34/pal-mcp-server/commit/1f209d55651ee5ba743b4d3b22a2385440da5f9e))
...
- **openai_compatible**: Fail fast on insufficient_quota / billing-cap 429s
  ([`1a5a3f9`](https://github.com/bigl34/pal-mcp-server/commit/1a5a3f934aa3f1d86e50592695a4b7b7a9204a40))

### Chores

- Enable Entire guards
  ([`6041d10`](https://github.com/bigl34/pal-mcp-server/commit/6041d10cca7572c50587eaac37b447d0dd55578d))

- Port useful pal patch metadata
  ([`96c29a1`](https://github.com/bigl34/pal-mcp-server/commit/96c29a12e8f4bb9f558cfa7b734803d8a5cff620))

- Sync version to config.py [skip ci]
  ([`7afc7c1`](https://github.com/bigl34/pal-mcp-server/commit/7afc7c1cc96e23992c8f105f960132c657883bb1))

### Continuous Integration

- Add entire checkpoint coverage
  ([`5d65197`](https://github.com/bigl34/pal-mcp-server/commit/5d65197fb48df4d6eaa3fc329b027c205a51303f))

### Documentation

- Clarify this is a fork and how it deploys
  ([`6a76c43`](https://github.com/bigl34/pal-mcp-server/commit/6a76c4398aec282fbc5b00487d8388455e701397))

- Document Entire bypass permission
  ([`84d80f5`](https://github.com/bigl34/pal-mcp-server/commit/84d80f58b2b6a9c7f4545f579fd3428e1da4f70c))

### Testing

- Cover selected responses patch
  ([`35a7502`](https://github.com/bigl34/pal-mcp-server/commit/35a75027aeb442213d96e3d0ec2aa75da5bd9943))

- Isolate openrouter restriction state
  ([`8cd61c8`](https://github.com/bigl34/pal-mcp-server/commit/8cd61c82e2b33428d3a2521cf7719b3cc0e1436c))


## v9.8.2+fork.6 (2026-06-21) — fork

### Bug Fixes

- Update OpenAI-compatible `/v1/responses` requests to use multimodal content
  parts, background polling, and `max_output_tokens`.

### Documentation

- Clarify how this fork is deployed from the local checkout.

## v9.8.2+fork.1 (2026-05-12) — fork

Maintained fork of `BeehiveInnovations/pal-mcp-server`. See `FORK.md` for rationale
and rebase instructions.

### Bug Fixes

- Wrap every sync `provider.generate_content(...)` call in
  `await asyncio.to_thread(...)` across `tools/consensus.py`,
  `tools/simple/base.py` (primary + retry paths) and
  `tools/workflow/workflow_mixin.py` so a blocked HTTP read
  (e.g. zombie TCP connection after host suspend) no longer freezes
  the entire MCP asyncio event loop — stdin reader, MCP cancellation,
  and concurrent tool calls all stay live.
