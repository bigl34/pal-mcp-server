...
class ModelProvider(ABC):
        ...
        *,
        ...
        if restriction_service:
            ...
            for model_name, config in model_configs.items():
                if restriction_service.is_allowed(
    ...
    def _ensure_model_allowed(
        ...
        alternate_names = [requested_name]
        if capabilities.provider_model_name:
            alternate_names.append(capabilities.provider_model_name)

        for alternate_name in alternate_names:
            if restriction_service.is_allowed(self.get_provider_type(), canonical_name, alternate_name):
                return
